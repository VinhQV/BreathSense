...
#include "sl_simple_button_bt_01_config.h"

sl_simple_button_context_t simple_bt_01_context = {
  .state = 0,
  .history = 0,
  .port = SL_SIMPLE_BUTTON_BT_01_PORT,
  .pin = SL_SIMPLE_BUTTON_BT_01_PIN,
  .mode = SL_SIMPLE_BUTTON_BT_01_MODE,
};

const sl_button_t sl_button_bt_01 = {
  .context = &simple_bt_01_context,
...
{
  sl_button_init(&sl_button_bt_01);
}

void sl_simple_button_poll_instances(void)
{
  sl_button_poll_step(&sl_button_bt_01);
}
